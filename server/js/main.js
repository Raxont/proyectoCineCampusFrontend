const { mainLugar, mainBoleta, mainAsientos, mainTarjetas, mainCliente } = require ("./modules/funciones");
    ...
    */
    ...
    const actionAsientos = "getReserva"; //* Acción por defecto el cual debe de ser modificando según la necesidad. Usa 'getReserva', 'returnReserva'.
