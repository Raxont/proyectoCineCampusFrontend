const ClienteRepository  = require("./cliente"); //  Importa el repositorio de tarjeta
const BoletaRepository  = require("./boleta"); //  Importa el repositorio de boleta
const LugarRepository  = require("./lugar"); //  Importa el repositorio de lugar
const asientoRepository  = require("./asientos"); //  Importa el repositorio de asiento
const TarjetaRepository  = require("./tarjeta"); //  Importa el repositorio de tarjeta
  ...
  try {
    ...
    if (action === "getAll") {
      ...
      const nuevaBoleta = {
        ...
        id_lugar: new ObjectId("66a585133098ad52758cab05"), //  Reemplaza con ObjectId válidos de la base de datos
       ...
       */
      const idLugar = new ObjectId("66a52b6c89b4ae4007773f2c"); //  Reemplaza con la identificación del lugar que deseas buscar asientos disponibles
...
async function mainAsientos(action) {
  try {
    ...
    if (action === "getReserva") {
       ...
       */
      const informacion = {
        idAsiento: new ObjectId("66a6d3fa1c9570011db88fe0"), // Reemplaza con el ID del asiento
        idLugar: new ObjectId("66a52b6c89b4ae4007773f2c"), // Reemplaza con el ID del lugar
